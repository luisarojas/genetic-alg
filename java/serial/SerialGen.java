...
public class SerialGen {
	...
	//parallizable
	SerialGen.MAX_THREADS = 64;
	SerialGen.TARGET_LEN = 5;
	...
	for(SerialGen.NUM_THREADS = 1; SerialGen.NUM_THREADS <= SerialGen.MAX_THREADS; SerialGen.NUM_THREADS++){
	    int sum = 0;
	    ...
	    System.out.println(SerialGen.NUM_THREADS + "," + avg_generations);
	}
    }
}
